...
int LIBUSB_CALL Linux_UsbPort_Open(uint16_t vid, uint16_t pid);
void LIBUSB_CALL Linux_UsbPort_Close();
int LIBUSB_CALL Linux_UsbPort_Write(unsigned char* data, int len);
LIBUSB_CALL unsigned char* Linux_UsbPort_Read();
void LIBUSB_CALL Linux_UsbPort_FreePtr(unsigned char* ptr);
